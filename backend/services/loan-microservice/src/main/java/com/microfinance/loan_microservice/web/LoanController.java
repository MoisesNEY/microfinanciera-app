...
public class LoanController {
    ...
    @PreAuthorize("hasAnyRole('admin_general', 'asesor_credito', 'supervisor_creditos', 'jefe_creditos', 'cobrador', 'gestor_mora', 'gerente_general', 'cajero', 'jefe_cobranza', 'jefe_finanzas', 'analista_financiero', 'contador', 'asistente_contable', 'jefe_contabilidad', 'archivador')")
    @GetMapping("/deleted")
    ...
    @PreAuthorize("hasAnyRole('admin_general', 'asesor_credito', 'cobrador', 'jefe_creditos', 'jefe_caja', 'tesorero', 'cajero', 'jefe_cobranza', 'jefe_finanzas', 'analista_financiero', 'contador', 'asistente_contable', 'jefe_contabilidad', 'archivador')")
    ...
    @PreAuthorize("hasAnyRole('admin_general', 'asesor_credito', 'cobrador', 'cajero', 'jefe_creditos', 'jefe_caja', 'tesorero', 'jefe_cobranza', 'jefe_finanzas', 'analista_financiero', 'contador', 'asistente_contable', 'jefe_contabilidad', 'archivador')")
