 ...
 * por nombre lógico, código o nombre. Implementa cache para evitar consultas repetidas.
 */
@Slf4j
@Service
public class AccountLookupService {
     ...
     * 
     * @param logicalNameOrCodeOrName Nombre lógico (ej: "CASH_ACCOUNT"), código (ej: "1001") o nombre de la cuenta
    ...
    public UUID lookupAccountId(String logicalNameOrCodeOrName, String bearerToken) {
        ...
        try {
            ...
            throw new IllegalStateException(
                "Error al consultar cuenta contable " + logicalNameOrCodeOrName + ": " + e.getMessage(), 
                e
            );
        }
    }
